        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('My Availabilit')">
                        {{ __('MySchedule') }}
                    </x-nav-link>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link href="/admin/accepted/employeeavail/">Review Requested Employee Availability</x-dropdown-link>
                         ...
                         <x-dropdown-link href="/admin/userlist/">Edit Users</x-dropdown-link>
                 ...
                 <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link href="/admin/createshift/">Create Shifts</x-dropdown-link>
                         <x-dropdown-link href="/admin/showshift/">Show New Shifts</x-dropdown-link>
                         <x-dropdown-link href="/admin/AutoAssign/">Assign Shifts</x-dropdown-link>
