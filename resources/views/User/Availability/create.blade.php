            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="overflow-x-auto relative">
                    <div class="w-full max-w-xs">
                        ...
                        <div style ="border: 1px solid lightgray; background-color: red; width: 70%;">
                         <div class ="mb-6">
                            {!! Form::label('yhursday_start_time', 'Thursday Start Time', ['class' => 'block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300']) !!}
                            {!! Form::select('name', [ '',
                              0 => '0000',
                              1 => '0100',
                              2 => '0200',
                        ...
                        <div style ="border: 1px solid lightgray; background-color: red; width: 70%;">
                         <div class ="mb-6">
                            {!! Form::label('sunday_start_time', 'Start Time', ['class' => 'block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300']) !!}
                            {!! Form::select('name', [ '',
                              0 => '0000',
                              1 => '0100',
                              2 => '0200',
                        ...
                        <div class ="mb-6">
                            {!! Form::label('sunday_end_time', 'End Time', ['class' => 'block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300']) !!}
                            {!! Form::select('end_time', [ '',
                              0 => '0000',
                              1 => '0100',
                              2 => '0200',
